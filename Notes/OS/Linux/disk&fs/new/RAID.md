...
- n 块 read/write I/O 性能相同(或者不相同)的磁盘组成 RAID 0，提供 $n \times min(write\ I/O)$ write I/O 性能，$n \times min(read\ I/O)$ read I/O 性能
...
除了磁盘之间可以互相组 RIAD，还可以 RAID 之间互相组 RAID，这种形式的 RAID 被称为 Nested(Hybrid) RAID。通常由 2 个数字
